...
const AboutPage = () => {
    return (
        <div className='about-page'>
            <p>Come in, traveler and tell us a little tale! This apt is a story prompter, giving you three items to work with. It provides a person, a item, and a monster. You will provide the rest! This is for lighthearted fare: your stories can be serious, silly, or anywhere in between. </p>
